        ...
        <StudentLayout active="subjects" title={subject.name}>
            ...
            <section className="hero-pattern mb-8 rounded-3xl bg-[#142E36] p-6 text-white sm:p-8">
                <div className="flex flex-wrap items-center justify-between gap-6">
                    <div><span className="mb-5 inline-flex rounded-2xl border border-white/15 bg-white/10 p-3 text-teal-200"><Icon name="calculator" className="h-7 w-7" /></span><p className="text-[10px] font-bold uppercase tracking-[0.2em] text-teal-200">Ruang mata pelajaran</p><h1 className="mt-2 text-3xl font-extrabold tracking-tight">{subject.name}</h1><p className="mt-3 flex items-center gap-2 text-sm text-slate-300"><Icon name="user" className="h-4 w-4" />{subject.teacher}</p></div>
